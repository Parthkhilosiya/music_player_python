...
def addsongs():
    ...
    temp_song=filedialog.askopenfilenames(initialdir="Music player/",title="Choose a song", filetypes=(("mp3 Files","*.mp3"),))
    #loop through everyitem in the list
    for s in temp_song:
        s=s.replace("D:\music player\music","")
...
def Previous():
    ...
    temp2=f'D:\music player\music/{temp2}'
...
def Next():
    ...
    temp=f'D:\music player\music/{temp}'
